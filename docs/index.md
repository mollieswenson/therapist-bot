...
[Constants]() exclamationResponses genericResponses povSwitches questionResponses questionStarts [Functions]() createQuestion(patientLine) initialize() lastChar(myString) randomGif (id) submitLine() randomElement(myArray) [Enumerations]() Generic Question Exclamation PointOfView
